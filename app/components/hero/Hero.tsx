          ...
          <div className="flex  flex-col gap-5 text-center text-base-content">
            ...
            <div className="flex justify-center">
              <p className="text-justify max-w-[540px]">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                {`" I'm a web developer
                  based in Thailand, ready to contribute to the exciting
                  project. Let's connect, collaborate and build something
                  amazing together! "`}
              </p>
            </div>
            ...
            <div className="text-center pt-3">
              <button className="btn btn-warning hover:btn-primary transition ease-in-out hover:-translate-y-0.5 hover:scale-110 duration-300 gap-3">
