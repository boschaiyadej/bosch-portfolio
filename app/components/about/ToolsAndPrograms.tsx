...
import { GiArchiveResearch, GiHazardSign } from "react-icons/gi";
...
const toolsAndPrograms = [
  ...
  { icon: GrVirtualMachine, label: "WEKA (Machine Learning)" },
  { icon: GiHazardSign, label: "ALOHA (Hazard Modeling)" },
];
